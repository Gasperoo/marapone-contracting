...
export const PACK_FULFILMENT = {
  'pack-code-library': {
    ...
    opens: 'Open the folder for the jurisdiction you are working in — Ontario for the provincial code, Toronto for the municipal layer. Each holds the same PDF and CSV pair.',
  ...
  'pack-assembly-schema': {
    ...
    opens: 'Open schema-reference.pdf for the 27 properties in plain language, then the north-america folder for the JSON and CSV.',
    use: 'The JSON keeps the property-to-assembly join in both directions; the CSVs materialise it so a spreadsheet does not have to. Tree is CSI MasterFormat.',
  },
  'pack-rate-2026': {
    label: 'the Estimating Rate Pack (2026 Edition)',
    opens: 'Open the Ontario/Toronto rate table, then the contingency framework alongside it.',
  ...
  'pack-bid-leveling': {
    ...
    opens: 'Open the workbook and go to the Comparison Matrix tab; the scope checklist behind it is the tab before.',
    use: 'Leave a cell blank where a bidder did not price the element — blank is what makes the gap flag fire. A zero says "priced at nil", which is a different claim.',
  },
  ...
  'pack-bundle': {
    ...
    use: 'They share a spine: everything is indexed by CSI code, so a requirement, its assembly and its rate line up across the packs instead of needing to be reconciled by hand.',
  },
};
