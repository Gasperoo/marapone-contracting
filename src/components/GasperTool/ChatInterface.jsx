...
export function ChatInterface() {
    ...
    return (
        <div className="flex h-full overflow-hidden rounded-2xl border border-black/[0.08] bg-white/50 backdrop-blur-xl relative">
            ...
            <div className="flex-1 flex flex-col relative bg-gradient-to-br from-transparent to-white/05">
                {/* Chat Header */}
                <div className="h-14 border-b border-black/[0.04] flex items-center px-6 justify-between bg-white/05 backdrop-blur-md z-10">
                    <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-[#FF6B00] to-[#FF9FFC] flex items-center justify-center shadow-lg shadow-purple-500/20">
                            <Zap size={16} text="white" fill="white" />
                        </div>
                        <div>
                            <h3 className="font-semibold text-[#1a1a1a] text-sm">Gasper AI</h3>
                        ...
                        <div className="max-w-3xl mx-auto mt-10">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div onClick={() => handleCardClick("Classify HS Code for...")} className="chat-welcome-card group">
                                    <div className="w-10 h-10 rounded-full bg-blue-500/20 flex items-center justify-center mb-4 text-[#FF6B00] group-hover:scale-110 transition-transform">
                                        <Search size={20} />
                                    </div>
                                ...
                                <div onClick={() => handleCardClick("Estimate landed cost for...")} className="chat-welcome-card group">
                                    <div className="w-10 h-10 rounded-full bg-purple-500/20 flex items-center justify-center mb-4 text-[#FF6B00] group-hover:scale-110 transition-transform">
                                        <Box size={20} />
                                    </div>
                        ...
                        <div key={message.id} className={cn("flex w-full", message.role === 'user' ? "justify-end" : "justify-start")}>
                            <div className={cn("flex max-w-[85%] md:max-w-[75%]", message.role === 'user' ? "flex-row-reverse" : "flex-row")}>
                                ...
                                <div className={cn("w-8 h-8 rounded-full flex items-center justify-center shrink-0 mt-1",
                                    message.role === 'user' ? "bg-black/[0.06] ml-3" : "bg-gradient-to-tr from-[#FF6B00] to-[#FF9FFC] mr-3 shadow-lg shadow-purple-500/20")}>
                                    {message.role === 'user' ? <div className="text-xs font-bold text-[#1a1a1a]">You</div> : <Zap size={14} fill="white" text="white" />}
                                </div>
                    ...
                    {isLoading && (
                        <div className="flex w-full justify-start">
                            <div className="flex max-w-[85%] flex-row">
                                <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-[#FF6B00] to-[#FF9FFC] flex items-center justify-center shrink-0 mt-1 mr-3 shadow-lg shadow-purple-500/20">
                ...
                <div className="p-4 md:p-6 pt-2">
                    <div className="relative">
                        <form onSubmit={handleSubmit} className="relative z-10">
                            <Textarea
                                ...
                                className="w-full bg-white/80 border-black/[0.08] rounded-xl pl-4 pr-14 py-4 min-h-[60px] max-h-[200px] shadow-2xl focus:border-[#FF6B00]/50 focus:ring-1 focus:ring-[#FF6B00]/50 text-[#1a1a1a] placeholder:text-gray-300 resize-none custom-scrollbar"
                                onKeyDown={(e) => {
                            ...
                            <Button
                                ...
                                className="absolute right-3 bottom-3 h-9 w-9 bg-[#FF6B00] hover:bg-[#431ce0] text-[#1a1a1a] rounded-lg shadow-lg shadow-purple-500/30 transition-all hover:scale-105"
                            >
                                <Send size={16} />
                            </Button>
                        </form>
                    ...
                    <div className="text-center mt-3">
                        <p className="text-[10px] text-gray-200">AI analyses are estimates based on available data. Verify critical information with official sources.</p>
                    </div>
                </div>
            </div>
        </div>
