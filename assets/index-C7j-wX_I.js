import{r as w,a as ke,R as ae,L as je,B as Be,b as Le,c as ie}from"./react-vendor-BcREprs3.js";import{C as re,D as Ie,R as Oe,L,a as I,V as d,W as Ne,b as Ue,S as se,c as oe,M as $,P as q,d as O,e as Ve,H as He,F as Ge,f as We,B as Ye,g as Xe,h as $e,A as qe}from"./three-vendor-Cv8pSpCK.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))l(a);new MutationObserver(a=>{for(const c of a)if(c.type==="childList")for(const x of c.addedNodes)x.tagName==="LINK"&&x.rel==="modulepreload"&&l(x)}).observe(document,{childList:!0,subtree:!0});function g(a){const c={};return a.integrity&&(c.integrity=a.integrity),a.referrerPolicy&&(c.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?c.credentials="include":a.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function l(a){if(a.ep)return;a.ep=!0;const c=g(a);fetch(a.href,c)}})();var ce={exports:{}},N={};/**
 * @license React
 ...
 */var Pe=w,Je=Symbol.for("react.element"),Ke=Symbol.for("react.fragment"),Qe=Object.prototype.hasOwnProperty,Ze=Pe.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,et={key:!0,ref:!0,__self:!0,__source:!0};function ue(h,n,g){var l,a={},c=null,x=null;g!==void 0&&(c=""+g),n.key!==void 0&&(c=""+n.key),n.ref!==void 0&&(x=n.ref);for(l in n)Qe.call(n,l)&&!et.hasOwnProperty(l)&&(a[l]=n[l]);if(h&&h.defaultProps)for(l in n=h.defaultProps,n)a[l]===void 0&&(a[l]=n[l]);return{$$typeof:Je,type:h,key:c,ref:x,props:a,_owner:Ze.current}}N.Fragment=Ke;N.jsx=ue;N.jsxs=ue;ce.exports=N;var r=ce.exports,P={},ne=ke;P.createRoot=ne.createRoot,P.hydrateRoot=ne.hydrateRoot;class le extends ae.Component{constructor(n){super(n),this.state={hasError:!1,error:null}}static getDerivedStateFromError(n){return{hasError:!0}}componentDidCatch(n,g){console.error("ErrorBoundary caught an error:",n,g),this.setState({error:n})}render(){return this.state.hasError?r.jsxs("div",{style:{padding:"2rem",textAlign:"center",color:"#e0e0e0",minHeight:"100vh",display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",backgroundColor:"#0a0e1a"},children:[r.jsx("h1",{style:{fontSize:"2rem",marginBottom:"1rem"},children:"Something went wrong"}),r.jsx("p",{style:{marginBottom:"2rem",color:"#999"},children:"Please refresh the page or try again later."}),r.jsx("button",{onClick:()=>window.location.reload(),style:{padding:"0.75rem 2rem",backgroundColor:"#4da6ff",color:"#fff",border:"none",borderRadius:"4px",cursor:"pointer",fontSize:"1rem"},children:"Reload Page"})]}):this.props.children}}function tt({mouseForce:h=20,cursorSize:n=100,isViscous:g=!1,viscous:l=30,iterationsViscous:a=32,iterationsPoisson:c=32,dt:x=.014,BFECC:F=!0,resolution:S=.5,isBounce:M=!1,colors:J=["#5227FF","#FF9FFC","#B19EEF"],style:he={},className:de="",autoDemo:E=!0,autoSpeed:R=.5,autoIntensity:A=2.2,takeoverDuration:k=.25,autoResumeDelay:j=1e3,autoRampDuration:B=.6}){const U=w.useRef(null),f=w.useRef(null),V=w.useRef(null),D=w.useRef(null),H=w.useRef(null),K=w.useRef(!0),G=w.useRef(null);return w.useEffect(()=>{if(!U.current)return;function p(s){let e;Array.isArray(s)&&s.length>0?s.length===1?e=[s[0],s[0]]:e=s:e=["#ffffff","#ffffff"];const t=e.length,i=new Uint8Array(t*4);for(let u=0;u<t;u++){const m=new re(e[u]);i[u*4+0]=Math.round(m.r*255),i[u*4+1]=Math.round(m.g*255),i[u*4+2]=Math.round(m.b*255),i[u*4+3]=255}const o=new Ie(i,t,1,Oe);return o.magFilter=L,o.minFilter=L,o.wrapS=I,o.wrapT=I,o.generateMipmaps=!1,o.needsUpdate=!0,o}const T=p(J),W=new Ve(0,0,0,0),_=`
