...
(function () {
  ...
  // The "More" nav menu used to be injected here at runtime. It is now static
  // HTML in every construction and logistics page, because a JS-injected nav item
  // silently vanished on any page that forgot to load this script — which is
  // exactly what happened on the two product pages.
