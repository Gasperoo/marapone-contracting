...
} from '../GasperTool/services/documentService';
                ...
                <div className="col-span-12 lg:col-span-5 space-y-6">
                    ...
                    <Card className="bg-[#0a0f18] border-blue-500/10 p-6 flex flex-col h-[380px]">
                        <h3 className="text-sm font-semibold text-[#1a1a1a] flex items-center gap-2 mb-6 uppercase tracking-wider">
                            <Cpu className="text-[#0EA5E9] w-4 h-4" />
                            Neural Extractions
                        </h3>
                        <div className="flex-1 overflow-y-auto space-y-4 pr-2 scrollbar-hide">
                            {ocrData ? (
                                ...
                                <div className="h-full flex flex-col items-center justify-center text-center opacity-20">
                                    <Layers size={48} className="mb-4 text-[#0EA5E9]" />
                        ...
                        <div className="flex-1 max-w-xl w-full">
                            {isDispatching ? (
                                <div className="space-y-4 w-full">
                                    <div className="flex justify-between text-[10px] font-bold uppercase tracking-widest text-[#0EA5E9]">
