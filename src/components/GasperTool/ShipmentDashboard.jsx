        ...
        return (
            <div className="flex items-center justify-center h-full min-h-[400px]">
                <div className="flex flex-col items-center gap-4">
                    <div className="w-12 h-12 rounded-full border-4 border-black/[0.08] border-t-[#FF6B00] animate-spin"></div>
                ...
                <div className="flex items-center gap-4 w-full md:w-auto overflow-x-auto no-scrollbar">
                    <div className="flex bg-black/20 p-1 rounded-lg border border-black/[0.08] shrink-0">
                        <button
                            ...
                            className={cn("px-3 py-1.5 rounded-md text-xs font-medium transition-all flex items-center gap-2", viewMode === 'list' ? "bg-[#FF6B00] text-[#1a1a1a] shadow-lg" : "text-gray-500 hover:text-[#1a1a1a]")}
                        >
                            <FileText size={14} /> List
                        </button>
                        <button
                            onClick={() => setViewMode('map')}
                            className={cn("px-3 py-1.5 rounded-md text-xs font-medium transition-all flex items-center gap-2", viewMode === 'map' ? "bg-[#FF6B00] text-[#1a1a1a] shadow-lg" : "text-gray-500 hover:text-[#1a1a1a]")}
                        >
                            <MapPin size={14} /> Map
                        </button>
                    </div>
                ...
                <div className="flex items-center gap-3 w-full md:w-auto">
                    <div className="relative flex-1 md:w-48">
                        ...
                        <input
                            ...
                            className="w-full bg-black/20 border border-black/[0.08] rounded-xl pl-10 pr-4 py-2 text-sm text-[#1a1a1a] focus:outline-none focus:border-[#FF6B00]/50 transition-colors"
                        />
                    </div>
                            ...
                            filteredShipments.map((shipment) => (
                                <div key={shipment.id} className="shipment-card group">
                                    ...
                                    <div className="shipment-progress-track">
                                        ...
                                        <div
                                            className="absolute top-1/2 left-0 h-0.5 bg-[#FF6B00] -translate-y-1/2 z-0 transition-all duration-1000"
                                            style={{
                                                ...
                                                <div key={index} className="relative z-10 flex flex-col items-center">
                                                    <div className={cn(
                                                        ...
                                                        status === 'completed' || status === 'active'
                                                            ? "border-[#FF6B00] text-[#FF6B00] shadow-[0_0_15px_rgba(82,39,255,0.4)]"
