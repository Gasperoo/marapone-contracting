...
export default function FeaturesPage() {
    ...
    const bgGlow = 'rgba(255, 107, 0, 0.15)';
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="flex justify-center mb-20">
                    <div className="inline-flex p-1.5 bg-white border border-black/5 rounded-2xl shadow-lg relative">
                        ...
                        >
                            <Ship size={20} className={activeTab === 'logistics' ? 'text-[#FF6B00]' : ''} />
                            Logistics
                        </button>
                                ...
                                <div className="mb-24 relative">
                                    ...
                                    <div className="bg-white/80 backdrop-blur-xl border border-black/5 rounded-3xl p-8 md:p-12 overflow-hidden shadow-xl">
                                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                                            <div>
                                                <h2 className="text-3xl font-bold text-[#1a1a1a] mb-6">The Global <span className="text-[#FF6B00]">Digital Twin</span></h2>
                                                ...
                                                <ul className="space-y-4 mb-8">
                                                    {[
                                                        { icon: <Globe className="text-[#FF6B00]" />, text: "Live AIS Vessel Tracking" },
                                                        { icon: <ShieldCheck className="text-[#F59E0B]" />, text: "Geopolitical Risk Overlays" },
                                                        { icon: <TrendingUp className="text-[#FF6B00]" />, text: "Predictive ETA Modeling" }
                                                    ].map((item, i) => (
                                                ...
                                                <Link to="/gasper" className="inline-flex items-center text-[#FF6B00] font-bold hover:text-[#F59E0B] transition-colors group">
                                            ...
                                            <div className="relative h-[400px] rounded-2xl bg-gradient-to-br from-[#FF6B00]/10 to-[#F5F5F5] border border-[#FF6B00]/20 flex items-center justify-center group overflow-hidden">
                                                <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10" />
                                                {/* Core Node */}
                                                <motion.div
                                                    animate={{ boxShadow: ['0 0 20px #FF6B00', '0 0 60px #F59E0B', '0 0 20px #FF6B00'] }}
                                                    transition={{ duration: 4, repeat: Infinity }}
                                                    className="w-24 h-24 rounded-full bg-white border-2 border-[#FF6B00] z-10 flex items-center justify-center relative shadow-lg"
                                                >
                                                    <Activity className="text-[#FF6B00] w-10 h-10" />
                                                    {/* Pulsing rings */}
                                                    <div className="absolute inset-0 rounded-full border border-[#FF6B00]/50 animate-ping" style={{ animationDuration: '3s' }} />
                                                </motion.div>

                                                {/* Connected Nodes */}
                                                <div className="absolute top-1/4 left-1/4 w-12 h-12 rounded-full bg-orange-100 border border-orange-300 flex items-center justify-center shadow-sm"><Ship size={20} className="text-[#FF6B00]" /></div>
                                                <div className="absolute bottom-1/4 right-1/4 w-12 h-12 rounded-full bg-amber-100 border border-amber-300 flex items-center justify-center shadow-sm"><Database size={20} className="text-[#F59E0B]" /></div>
                                                <div className="absolute top-1/3 right-1/4 w-12 h-12 rounded-full bg-orange-50 border border-orange-200 flex items-center justify-center shadow-sm"><Globe size={20} className="text-[#FF6B00]" /></div>
                                                ...
                                                <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-50">
                                                    ...
                                                    <path d="M 50% 50% L 75% 33%" stroke="#FF6B00" strokeWidth="2" strokeDasharray="5,5" className="animate-pulse" style={{ animationDelay: '0.5s' }} />
                                                </svg>
                                            </div>
                                        </div>
                                    </div>
