...
export const PRODUCTS = {
  ...
  pair: {
    label: 'Blueprint Auditor + AI Estimator',
    price: 1690,
    description: 'Both products, wired together so takeoff flows straight into the priced bid. Includes a setup call on a real job of yours. One-time purchase, full source code, no subscription.',
  },
};
